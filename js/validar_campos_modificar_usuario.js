function validarCampos() {
	...
	if (nombre.length == 0 && apellido.length == 0 && cedulaTexto.length == 0 && direccion.length == 0 && usuario.length == 0 && telefonoTexto.length == 0 && correo.length == 0 && confirmar_correo.length == 0) {
	...
	if (confirmar_password.length > 1 && confirmar_password.length < 6) {
